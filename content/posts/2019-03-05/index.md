...
Anyways, I found f-labs interesting so wrote about it. Then we had a talk with almost all the exhibitors. 
...
Then It was about time we attend the session we planned.  We attended "**Cybersecurity and Privacy from the Global Lens**" by [Eva Galperin](https://twitter.com/evacide) . Also tweeted about.
...
`````
Machine learning is just a buzz word. It is basically lots of data provided to an algorithm to make calcuated guess.
`````
...
This was the end of Day 1 talks and workshops. Later we attended the Invite only Nullcon met few new people and then were Invited to another private party by [Bug discover](https://www.bugdiscover.com/). Went to bed around 3:00 am. Still regret not going to bed early.
